export default function Contact() {
    return (
        <div className="p-20">
      <form className="w-[50%] p-20 rounded-[10px] shadow-[0_2px_4px_darkslategray] flex flex-col text-plus bg-white"
      action="/api/contact" method="POST">
        ...
        <div className="flex flex-col">
          <label htmlFor="frm-phone" className="mb-2">Phone</label>
          <input
            name="phone"
            placeholder="Phone"
            required
